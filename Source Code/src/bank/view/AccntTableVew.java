...
import java.awt.*;
public class AccntTableVew extends JFrame{
	private JTable tble;
	...
	public AccntTableVew(String arg0, JTable tbl) throws HeadlessException {
		super(arg0);
		this.tble = tbl;
		spn=new JPanel();
		spn.setLayout(new BoxLayout(spn,BoxLayout.Y_AXIS));
		Bckgrndtb con=new Bckgrndtb();
...
class Bckgrndtb extends JPanel
{
