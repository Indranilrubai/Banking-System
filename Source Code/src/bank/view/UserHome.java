...
public class UserHome extends JFrame 
{
	...
	private JButton b1;
	public UserHome(String arg0) throws HeadlessException {
		super(arg0);
		// TODO Auto-generated constructor stub
		
		spn=new JPanel();
		spn.setLayout(new BoxLayout(spn,BoxLayout.Y_AXIS));
		UBckgrnd con=new UBckgrnd();
...
class UBckgrnd extends JPanel
{
	...
	{
		Image a=Toolkit.getDefaultToolkit().getImage("image\\u1.jpg");
