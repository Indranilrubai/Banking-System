...
public class UsrTransctnDetls extends JFrame{
	private JPanel spn,p1,p2,p3,p4;
	private JLabel l1,l2,l3,l4,l5,l6,l7,l8,bl1,bl2,bl3,l9,l10;
	private JButton b1;
	private String [] data;
	private JComboBox<String> jcmacc;
	private JPanel pnl,pnl1,pnl2;
	private JLabel lbl1;
	private JButton btnTransctn;
	public UsrTransctnDetls(String arg0, String[] data)throws HeadlessException {
		super(arg0);
		this.data = data;
		spn=new JPanel();
		spn.setLayout(new BoxLayout(spn,BoxLayout.Y_AXIS));
		UBckgrndtrns con=new UBckgrndtrns();
		...
		jcmacc=new JComboBox<String>(data);
		pnl=new JPanel();
		pnl.setLayout(new BoxLayout(pnl, BoxLayout.Y_AXIS));
		pnl1=new JPanel();
		lbl1=new JLabel("Select Account No");
		lbl1.setFont(new Font("Century Gothic", Font.PLAIN, 26));
		jcmacc=new JComboBox<String>(data);
		jcmacc.setFont(new Font("Century Gothic", Font.PLAIN, 26));
		pnl1.add(lbl1);
		pnl1.add(jcmacc);
		pnl2=new JPanel();
		ImageIcon ui=new ImageIcon("image\\trans.png");
		btnTransctn=new JButton("Get Transactions",ui);
		pnl2.add(btnTransctn);
		btnTransctn.setFont(new Font("Century Gothic", Font.PLAIN, 26));
		pnl.add(pnl1);
		pnl.add(pnl2);
		pnl.setOpaque(false);
	...
	public JComboBox<String> getJcmacc() {
		return jcmacc;
	}
	public JButton getBtnTransctn() {
		return btnTransctn;
	}
}
class UBckgrndtrns extends JPanel
{
	public UBckgrndtrns() {
		setOpaque(false);
	...
	{
		Image a=Toolkit.getDefaultToolkit().getImage("image\\u8.jpg");
