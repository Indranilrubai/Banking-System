...
public class AccTransferMoney extends JFrame 
{
	...
	private JButton b1;
	public AccTransferMoney(String arg0) throws HeadlessException {
		super(arg0);
		// TODO Auto-generated constructor stub
		spn=new JPanel();
		spn.setLayout(new BoxLayout(spn,BoxLayout.Y_AXIS));
		Bckgrndtnsf con=new Bckgrndtnsf();
		...
		pnl1=new JPanel();
		lbl1=new JLabel("------:Balance Transfer:------");
		lbl1.setFont(new Font("Century Gothic", Font.PLAIN, 36));
		pnl1.add(lbl1);
		pnl2=new JPanel();
		lbl2=new JLabel("Enter Sender's Bank Account No:-");
		...
		pnl2.add(tf1);
		pnl3=new JPanel();
		lbl3=new JLabel("Enter Receiver's Bank Account No:-");
		lbl3.setFont(new Font("Century Gothic", Font.PLAIN, 16));
		tf2=new JTextField(20);
		tf2.setFont(new Font("Century Gothic", Font.PLAIN, 16));
		pnl3.add(lbl3);
		pnl3.add(tf2);
		pnl4=new JPanel();
		ImageIcon ic=new ImageIcon("image\\mntrnsf.png");
		btnTrans=new JButton("Transfer",ic);
		btnTrans.setFont(new Font("Century Gothic", Font.PLAIN, 16));
		pnl4.add(btnTrans);
		pnl5=new JPanel();
		lbl4=new JLabel("Enter Amount:-");
		lbl4.setFont(new Font("Century Gothic", Font.PLAIN, 16));
...
class Bckgrndtnsf extends JPanel
{
	...
	{
		Image a=Toolkit.getDefaultToolkit().getImage("image\\acctnf.jpg");
