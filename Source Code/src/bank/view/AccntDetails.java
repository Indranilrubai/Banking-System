...
public class AccntDetails extends JFrame
{
	private JPanel pnl,pnl1,pnl2,pnl3,pnl4,pnl5,pnl6;
	private JTextField tfAccId;
	private JButton btnSrch;
	private JPanel spn,p1,p2,p3,p4;
	private JLabel l1,l2,l3,l4,l5,l6,l7,l8,bl1,bl2,bl3,l9,l10;
	private JButton b1;
	private JLabel lblAccId2,lblUid2,lblUid,lblHldrNm2,lblHldrNm,lblBal2,lblBal,lblMinBl2,lblMinBl,lbltype2,lbltype;
	public AccntDetails(String arg0) throws HeadlessException {
		super(arg0);
		// TODO Auto-generated constructor stub
		spn=new JPanel();
		spn.setLayout(new BoxLayout(spn,BoxLayout.Y_AXIS));
		Bckgrndad con=new Bckgrndad();
		...
		pnl1=new JPanel();
		lblAccId2=new JLabel("Enter The Account No:-");
		...
		pnl6.add(lbltype2);
		pnl6.add(lbltype);
		lblMinBl2=new JLabel();
		lblMinBl2.setFont(new Font("Century Gothic", Font.PLAIN, 16));
		lblMinBl=new JLabel();
		lblMinBl.setFont(new Font("Century Gothic", Font.BOLD, 16));
		pnl5=new JPanel();
		pnl5.add(lblMinBl2);
		pnl5.add(lblMinBl);
		pnl.add(pnl1);
		...
		pnl.add(pnl4);
		pnl.add(pnl5);
		lblAccId2.setForeground(new Color(83, 72, 11));
		lblUid2.setForeground(new Color(83, 72, 11));
		lblUid.setForeground(new Color(83, 72, 11));
		lblHldrNm2.setForeground(new Color(83, 72, 11));
		lblHldrNm.setForeground(new Color(83, 72, 11));
		lblBal2.setForeground(new Color(83, 72, 11));
		lblBal.setForeground(new Color(83, 72, 11));
		lblMinBl2.setForeground(new Color(83, 72, 11));
		lblMinBl.setForeground(new Color(83, 72, 11));
		lbltype2.setForeground(new Color(83, 72, 11));
		lbltype.setForeground(new Color(83, 72, 11));
		pnl.setOpaque(false);
	...
	public JLabel getLblAccId2() {
		return lblAccId2;
	}
	public JLabel getLblUid2() {
		return lblUid2;
	}
	public JLabel getLblHldrNm2() {
		return lblHldrNm2;
	}
	public JLabel getLblBal2() {
		return lblBal2;
	}
	public JLabel getLbltype2() {
		return lbltype2;
	}
}
class Bckgrndad extends JPanel
{
	...
	{
		Image a=Toolkit.getDefaultToolkit().getImage("image\\achm.jpg");
