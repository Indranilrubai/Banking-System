...
public class AccountantHome extends JFrame 
{
	...
	private JButton b1;
	public AccountantHome(String arg0) throws HeadlessException {
		super(arg0);
		// TODO Auto-generated constructor stub
		spn=new JPanel();
		spn.setLayout(new BoxLayout(spn,BoxLayout.Y_AXIS));
		Bckgrnd con=new Bckgrnd();
...
class Bckgrnd extends JPanel
{
	...
	{
		Image a=Toolkit.getDefaultToolkit().getImage("image\\achmf.jpg");
