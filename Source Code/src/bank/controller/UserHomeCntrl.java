...
public class UserHomeCntrl {
	private UserHome uhm;
	private JTable jtb;
	...
	public UserHomeCntrl(UserHome uhm) {
		this.uhm = uhm;
		try {
	...
	public void control()
	{
		uhm.getB1().addActionListener((a)->{
			
		});
		uhm.getL1().addMouseListener(new MouseAdapter() {
			@Override
		...
		uhm.getL2().addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				// TODO Auto-generated method stub
				//See All Account
		...
		uhm.getL4().addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				// TODO Auto-generated method stub
				//Transfer Money
		...
		uhm.getL7().addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				// TODO Auto-generated method stub
				//Transaction Details
		...
		uhm.getL9().addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				// TODO Auto-generated method stub
				//Edit Your Details
		...
		uhm.getL6().addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				// TODO Auto-generated method stub
				//Log Out
		...
		uhm.getL3().addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				// TODO Auto-generated method stub
